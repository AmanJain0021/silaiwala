               ...
               >
                  ...
                  <div className="text-center relative">
                    ...
                    <div className="aspect-square bg-white border-2 border-slate-50 rounded-[1.5rem] flex items-center justify-center p-5 mb-6 shadow-xl relative group">
                       <img src={`https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=${encodeURIComponent(`upi://pay?pa=closh@upi&pn=Closh&am=${calculatedTotal}&cu=INR`)}`} alt="Payment QR" className="w-full h-full" />
