...
import { Lock, KeyRound, Scissors, Eye, EyeOff, ArrowLeft, CheckCircle2 } from 'lucide-react';
...
const TailorForgotPassword = () => {
    ...
    const handleSendOtp = async (e) => {
        ...
        try {
            ...
            if (checkRes.data.role !== 'tailor') {
                setError('This number is not registered as a Partner/Tailor.');
                setSendingOtp(false);
                return;
            }
    ...
    return (
        ...
        >
            <div className="w-full mb-4">
                ...
                >
                    <ArrowLeft size={16} className="mr-1" /> Back to Partner Login
                </button>
            </div>
            ...
            <div className="text-center mb-6 w-full">
                <h1 className="text-2xl sm:text-[26px] font-bold text-[#0F172A] tracking-tight mb-1">
                    {step === 'request' ? 'Partner Password Reset' : step === 'verify' ? 'Verify OTP' : 'Set New Password'}
                </h1>
                <p className="text-xs sm:text-[13px] font-medium text-[#64748B] max-w-[280px] mx-auto leading-relaxed">
                    {step === 'request' 
                        ...
                        : 'Create a new, strong password for your partner account.'}
                </p>
            </div>
