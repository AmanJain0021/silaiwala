                ...
                {currentTask ? (
                    ...
                    <div className="bg-white rounded-[2rem] p-8 border border-slate-100 shadow-sm flex flex-col items-center justify-center text-center">
                        ...
                        {availableOrders?.length > 0 ? (
                            <>
                                <p className="text-slate-600 font-bold mb-4">You have no active tasks, but there are <span className="text-[#843D9B]">{availableOrders.length} live orders</span> waiting!</p>
                                <button
