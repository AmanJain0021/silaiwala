        ...
        <div className="bg-gradient-to-r from-[#2D2F6F] to-[#843D9B] text-white p-5 sm:p-6 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-indigo-100 font-medium">{appName} Delivery Partner Legal Terms</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-4 text-slate-600 text-sm leading-relaxed custom-scrollbar">
          {isPrivacy ? (
            <>
              ...
              <p>{appName} ("we", "our", or "us") values your privacy. This policy details how we collect, use, and protect your information when enrolling and serving as a Delivery Partner.</p>
              ...
              <p>Your details are strictly used to process registration, assign delivery orders, calculate payouts, and ensure safety across the {appName} logistics network.</p>
            ...
            <>
              <p className="font-semibold text-slate-800">Effective Date: January 1, 2026</p>
              <p>Welcome to {appName}. By registering and operating as a Delivery Partner, you agree to comply with these Terms and Conditions.</p>
