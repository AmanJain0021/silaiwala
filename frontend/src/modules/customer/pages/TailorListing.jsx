            ...
            <div className="sticky top-0 z-50 bg-white/80 backdrop-blur-xl border-b border-gray-100 px-4 py-5 pt-safe shadow-sm">
                ...
                <div className="max-w-3xl mx-auto relative group">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-3 bg-gray-100/50 border border-transparent rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-[#843D9B]/10 focus:bg-white focus:border-[#843D9B]/20 transition-all placeholder:text-gray-400"
                    />
                </div>
            </div>
                        ...
                        filteredTailors.map((tailor, index) => (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-[#843D9B]/5 to-transparent rounded-bl-full translate-x-10 -translate-y-10 group-hover:translate-x-4 group-hover:-translate-y-4 transition-transform duration-500"></div>
                                        ...
                                        <div className="flex-1 min-w-0 pt-1">
                                            <div className="flex justify-between items-start mb-1">
                                                ...
                                                <div className="flex items-center gap-1 px-1.5 py-0.5 bg-indigo-50 text-[#843D9B] rounded-lg text-[10px] font-black border border-[#843D9B]/10">
                                                    {tailor.rating || 0} <Star size={8} className="fill-[#843D9B] text-[#843D9B]" />
                                                </div>
                                            </div>

                                            <div className="flex items-center gap-2 mb-2">
                                                <p className="text-[11px] text-[#843D9B] font-bold bg-indigo-50 px-2 py-0.5 rounded-md">
                                    ...
                                    <div className="mt-4 pt-3 border-t border-gray-50 flex items-center justify-between">
                                        ...
                                        <button className="text-[11px] font-black text-[#843D9B] flex items-center gap-1 group/btn">
