...
const TailorSelection = () => {
    ...
    if (isLoading) {
        return (
            <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-6 text-center">
                <Loader2 size={32} className="text-[#843D9B] animate-spin mb-4" />
    ...
    return (
        <div className="min-h-screen bg-gray-50 pb-20 font-sans">
            {/* Header */}
            <div className="sticky top-0 z-50 bg-[#843D9B] text-white px-4 py-4 flex items-center gap-3 pt-safe">
            ...
            <div className="bg-white px-6 py-6 flex justify-between items-center border-b border-gray-100">
                <div className="flex flex-col items-center gap-1">
                    <div className="w-6 h-6 rounded-full bg-[#843D9B] text-white text-[10px] flex items-center justify-center font-bold">1</div>
                    <span className="text-[10px] font-bold text-[#843D9B]">Service</span>
                </div>
                <div className="h-px bg-[#843D9B] flex-1 mx-4"></div>
                <div className="flex flex-col items-center gap-1">
                    <div className="w-6 h-6 rounded-full bg-[#843D9B] text-white text-[10px] flex items-center justify-center font-bold animate-pulse">2</div>
                    <span className="text-[10px] font-bold text-[#843D9B]">Tailor</span>
                </div>
                    ...
                    >
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex items-center gap-3 text-[10px] text-gray-500">
                                ...
                                <span className="font-bold text-[#843D9B] bg-indigo-50 px-1 py-0.5 rounded text-[8px]">{tailor.experienceInYears || 0}Y Exp</span>
                            </div>
                        </div>
